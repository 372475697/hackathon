...
public interface ProjectManagementMapper {
    ...
    @Select("<script>" +
                ...
                "<if test='oppmOwner !=null  and oppmOwner !=\"\"'> and  ${oppmOwner} > 0 </if>" +
            "</script>")
    @Results({
